...
def test_compares_cursor_values_by_chronological_order():
    ...
    _slice = {"start_time": "01-01-2023","end_time": "01-04-2023"}
...
# TODO is this test necessary/valid anymore? If so, what is the correct way to deal with differing datetime formats?
def test_given_different_format_and_slice_is_highest_when_close_slice_then_state_uses_record_format():
    ...
    _slice = {"start_time": "2023-01-01T17:30:19.000Z","end_time": "2023-01-04T17:30:19.000Z"}
    record = Record({cursor_field: "2023-01-03"}, _slice)
