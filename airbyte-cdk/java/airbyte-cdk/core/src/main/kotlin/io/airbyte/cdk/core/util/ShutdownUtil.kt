...
/**
 * Collection of utility methods to ensure that any threads launched by a connector are cleaned up when an
 * operation completes.
 */
@Singleton
class ShutdownUtils {
    companion object {
         ...
         *
         *
         * **N.B.** Daemon threads don't block the JVM if the main `currentThread` exits, so they are not
